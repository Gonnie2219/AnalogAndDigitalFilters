...
/** Lowpass Sallen-Key SVG: series R1,R2; feedback C1; shunt C2 */
function SallenKeyLP({ section }: { section: SecondOrderSection }) {
  return (
    <svg viewBox="-10 -5 370 180" className="w-full max-w-[420px]" style={{ color: "var(--text)" }}>
      ...
      {/* C1 feedback (node A → Vout) */}
      <line x1="90" y1="50" x2="90" y2="35" stroke="currentColor" strokeWidth="1.5" />
      <line x1="78" y1="35" x2="102" y2="35" stroke="currentColor" strokeWidth="1.5" />
      <line x1="78" y1="30" x2="102" y2="30" stroke="currentColor" strokeWidth="1.5" />
      <line x1="90" y1="30" x2="90" y2="20" stroke="currentColor" strokeWidth="1.5" />
      <line x1="90" y1="20" x2="290" y2="20" stroke="currentColor" strokeWidth="1.5" />
      <line x1="290" y1="20" x2="290" y2="55" stroke="currentColor" strokeWidth="1.5" />
      <text x="106" y="36" fill="currentColor" fontSize="12" fontWeight="bold">C1</text>
      <text x="140" y="16" fill="var(--accent)" fontSize="11" fontWeight="600">{formatEngineering(section.C1)}F</text>
      {/* C2 shunt (node B → GND) */}
      <line x1="150" y1="50" x2="190" y2="50" stroke="currentColor" strokeWidth="1.5" />
      <line x1="170" y1="50" x2="170" y2="80" stroke="currentColor" strokeWidth="1.5" />
      <line x1="158" y1="80" x2="182" y2="80" stroke="currentColor" strokeWidth="1.5" />
      <line x1="158" y1="85" x2="182" y2="85" stroke="currentColor" strokeWidth="1.5" />
      <line x1="170" y1="85" x2="170" y2="105" stroke="currentColor" strokeWidth="1.5" />
      <text x="186" y="82" fill="currentColor" fontSize="12" fontWeight="bold">C2</text>
      <text x="186" y="98" fill="var(--accent)" fontSize="11" fontWeight="600">{formatEngineering(section.C2)}F</text>
      <line x1="160" y1="105" x2="180" y2="105" stroke="currentColor" strokeWidth="1.5" />
      <line x1="163" y1="109" x2="177" y2="109" stroke="currentColor" strokeWidth="1" />
      <line x1="166" y1="113" x2="174" y2="113" stroke="currentColor" strokeWidth="0.8" />
      {/* Op-amp */}
      ...
      <line x1="290" y1="130" x2="290" y2="55" stroke="currentColor" strokeWidth="1.5" />
...
/** Highpass Sallen-Key SVG: series C1,C2; feedback R1; shunt R2 */
function SallenKeyHP({ section }: { section: SecondOrderSection }) {
  return (
    <svg viewBox="-10 -5 370 180" className="w-full max-w-[420px]" style={{ color: "var(--text)" }}>
      ...
      <line x1="80" y1="50" x2="100" y2="50" stroke="currentColor" strokeWidth="1.5" />
      {/* R1 feedback (node A → Vout) */}
      <line x1="90" y1="50" x2="90" y2="20" stroke="currentColor" strokeWidth="1.5" />
      <line x1="90" y1="20" x2="290" y2="20" stroke="currentColor" strokeWidth="1.5" />
      <line x1="290" y1="20" x2="290" y2="55" stroke="currentColor" strokeWidth="1.5" />
      <rect x="160" y="12" width="40" height="16" fill="none" stroke="currentColor" strokeWidth="1.5" rx="2" />
      <text x="180" y="10" fill="currentColor" fontSize="12" fontWeight="bold" textAnchor="middle">R1</text>
      <text x="210" y="16" fill="var(--accent)" fontSize="11" fontWeight="600">{formatEngineering(section.R1)}Ω</text>
      {/* R2 shunt (node B → GND) */}
      <line x1="150" y1="50" x2="190" y2="50" stroke="currentColor" strokeWidth="1.5" />
      <line x1="170" y1="50" x2="170" y2="80" stroke="currentColor" strokeWidth="1.5" />
      <rect x="162" y="80" width="16" height="24" fill="none" stroke="currentColor" strokeWidth="1.5" rx="2" />
      <line x1="170" y1="104" x2="170" y2="110" stroke="currentColor" strokeWidth="1.5" />
      <text x="186" y="90" fill="currentColor" fontSize="12" fontWeight="bold">R2</text>
      <text x="186" y="106" fill="var(--accent)" fontSize="11" fontWeight="600">{formatEngineering(section.R2)}Ω</text>
      {/* Ground */}
      <line x1="160" y1="110" x2="180" y2="110" stroke="currentColor" strokeWidth="1.5" />
      <line x1="163" y1="114" x2="177" y2="114" stroke="currentColor" strokeWidth="1" />
      <line x1="166" y1="118" x2="174" y2="118" stroke="currentColor" strokeWidth="0.8" />
      {/* Op-amp */}
      <polygon points="190,35 190,75 240,55" fill="none" stroke="currentColor" strokeWidth="1.5" />
      <text x="194" y="48" fill="currentColor" fontSize="10">+</text>
      <text x="194" y="68" fill="currentColor" fontSize="10">-</text>
